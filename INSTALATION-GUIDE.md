...
# 🖥️ 3. Method 2 — Desktop Shortcut Pack (Beginner Friendly)

If you don’t want to type commands, download ready-made shortcuts.
...
2. Run **Install-Shortcuts.bat**
3. Shortcuts appear on your Desktop
4. Double-click any mode to start

All shortcuts:

* Auto-run as Administrator
* Use custom icons
* Pass profile settings automatically
